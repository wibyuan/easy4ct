...
因此，我们就证明了额外度数为 5 的孤立点是可约的。$\blacksquare$
...
> **定理（Tait 转化）**
>
> 任取一个极大平面图，它的点色数不超过 4，当且仅当它的对偶图边色数恰好为 3。

**证明：**

证明方法，居然是异或，注意到 01、10、11 的异或为 0。
...
因此，Tait 说明了，如果四色定理成立，那么任何一个极大平面图的对偶图的边色数不超过 3。$\blacksquare$
